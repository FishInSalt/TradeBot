...
async def test_base_exchange_start_default_noop():
    ...
    class DummyExchange(BaseExchange):
        ...
        async def cancel_order(self, order_id, symbol, is_algo: bool = False): ...
...
async def test_base_exchange_has_pending_market_order_default():
    ...
    class _Stub(BaseExchange):
        ...
        async def cancel_order(self, oid, s, is_algo: bool = False): ...
        async def fetch_funding_rate(self, s): ...
        async def fetch_open_interest_history(self, s, period="1h", limit=26): ...
        async def fetch_taker_flow(self, s, period="5m", limit=6): return []
